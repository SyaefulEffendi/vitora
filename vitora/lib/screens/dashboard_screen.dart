...
class _DashboardScreenState extends State<DashboardScreen> {
  ...
  Widget build(BuildContext context) {
    final userName = widget.userData?['nama'] ?? 'Julesia';
              ...
              Container(
                ...
                decoration: BoxDecoration(
                  gradient: LinearGradient(
                    colors: [Colors.white, const Color(0xFFE0FFFF).withOpacity(0.5)],
                  ...
                  children: [
                      ...
                      children: [
                        const Column(
                          ...
                          children: [
                            ...
                            Row(
                              children: [
                                Text('310', style: TextStyle(color: Color(0xFF008080), fontWeight: FontWeight.bold, fontSize: 16)),
                                Text(' / 1000 PTS', style: TextStyle(color: Colors.grey, fontWeight: FontWeight.bold, fontSize: 16)),
                              ],
                            ),
                          ],
                        ),
                    ...
                    Container(
                      ...
                      child: Row(
                        children: [
                          Container(
                            width: 120, // Approximated progress
                            decoration: BoxDecoration(
                              gradient: const LinearGradient(colors: [Color(0xFF008080), Color(0xFF00FFFF)]),
                              borderRadius: BorderRadius.circular(10),
                            ),
                            child: const Center(
                              child: Text('250 CP', style: TextStyle(color: Colors.white, fontSize: 8, fontWeight: FontWeight.bold)),
                            ),
                          ),
                          Expanded(
                            child: Center(
                              child: Text('500 CP', style: TextStyle(color: Colors.grey[600], fontSize: 8, fontWeight: FontWeight.bold)),
                            ),
                          ),
                        ],
                      ),
